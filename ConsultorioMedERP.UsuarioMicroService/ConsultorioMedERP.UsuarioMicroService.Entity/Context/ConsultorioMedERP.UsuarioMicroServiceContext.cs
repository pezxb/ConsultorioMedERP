...
{
    public class ConsultorioMedERP.UsuarioMicroServiceContext : DbContext
    {

        public ConsultorioMedERP.UsuarioMicroServiceContext(DbContextOptions<ConsultorioMedERP.UsuarioMicroServiceContext> options)
            : base(options)
        {
        }
